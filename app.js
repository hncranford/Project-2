var tableData = data;
var cData = _.values(censusdata[0]);
...
var myFeatureGroup = L.featureGroup().addTo(myMap).on("click", function (ev) {
    var lat = ev.latlng.lat;
    var lng = ev.latlng.lng;

    var selectedCity = cData.find(function (city) {
